...
public class StringHomework {
    public static void main(String[] args) {
        String[] names = {"Bogdan", "Maria", "Iulian", "Robert", "George", "Nicu", "Eu", "Alexandra", "Miruna", "Diana", "Raluca"};
        System.out.println("Exercise 1:");
        printAllStartingWithA(names);
        System.out.println("Exercise 2:");
        printAllContainingString(names, "r");
        ...
        System.out.println(abrebviereNumeMijlociuDacaEstePrezent("Maria Clara Popescu"));
        System.out.println(abrebviereNumeMijlociuDacaEstePrezent("Maria  Popescu"));
        System.out.println(abrebviereNumeMijlociuDacaEstePrezent("Maria   Miruna    Popescu"));
    }
    ...
    public static void printFirstThreeChars(String[] names) {
        for (String name : names) {
            if (name != null) {
                System.out.println(name.substring(0, Math.min(3, names.length)));
            }
        }
    ...
    public static void printRandomLetter(String[] names) {
        ...
        while (randomName == null || randomName.length() == 0) {
            randomName = names[random.nextInt(randomName.length())];
        }
        System.out.println(randomName.charAt(random.nextInt(randomName.length())));
    }
    //6.

    public static String abrebviereNumeMijlociuDacaEstePrezent(String name) {
